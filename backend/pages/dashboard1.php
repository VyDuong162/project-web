...
<body>
    ...
    <script src="/project-web/assets/vendor/Chart.js/Chart.min.js"></script>
    <script>
        $(document).ready(function(){
            function getDuLieuTongSoMatHang(){
                $.ajax('/project-web/backend/api/baocao-tongsomathang.php',{
            ...
            function getDuLieuBaoCaoTongSoKhachHang() {
                $.ajax('/project-web/backend/api/baocao-tongsokhachhang.php', {
                success: function(data) {
                    var dataObj = JSON.parse(data);
                    var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            function getDuLieuBaoCaoTongSoDonHang() {
                $.ajax('/project-web/backend/api/baocao-tongsoluongdonhang.php', {
                success: function(data) {
                    var dataObj = JSON.parse(data);
                    var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            function getDuLieuBaoCaoTongSoGopY() {
                $.ajax('/project-web/backend/api/baocao-tongsogopy.php', {
                success: function(data) {
                    var dataObj = JSON.parse(data);
                    var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            function renderChartThongKeLoaiSanPham() {
                $.ajax({
                url: '/project-web/backend/api/baocao-thongkeloaisanpham.php',
                type: "GET",
